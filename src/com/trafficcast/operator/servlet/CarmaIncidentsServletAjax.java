...
public class CarmaIncidentsServletAjax extends BaseServlet {
	...
	int totalCount = IncidentDAO.getCarmaIncidentsCount(markets, allMarkets);
	JSONArray jsonArray = JSONArray.fromObject(IncidentDAO.getCarmaIncidents(markets, allMarkets, Integer.parseInt(page), Integer.parseInt(rows)));
