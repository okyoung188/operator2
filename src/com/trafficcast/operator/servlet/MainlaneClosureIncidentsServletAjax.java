...
public class MainlaneClosureIncidentsServletAjax extends BaseServlet {
    ...
    public void executeServlet(HttpServletRequest request, HttpServletResponse response) throws Exception {	    
	    ...
	    int totalCount = IncidentDAO.getAllMainlaneCloureIncidentsCount(searchCriteria);	    
	    JSONArray jsonArray = JSONArray.fromObject(IncidentDAO.getAllMainlaneClosureIncidents(searchCriteria));
