...
public class RampClosureIncidentsServletAjax extends BaseServlet {
 ...
 public void executeServlet(HttpServletRequest request, HttpServletResponse response) throws Exception {	    
     String id = request.getParameter("id") == null ? "" : request.getParameter("id").trim();
	    ...
	    int totalCount = IncidentDAO.getAllRampCloureIncidentsCount(searchCriteria);	    
	    JSONArray jsonArray = JSONArray.fromObject(IncidentDAO.getAllRampClosureIncidents(searchCriteria));
