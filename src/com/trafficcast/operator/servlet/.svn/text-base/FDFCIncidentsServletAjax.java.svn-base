...
public class FDFCIncidentsServletAjax extends BaseServlet {
	...
	int totalCount = IncidentDAO.getFDFCIncidentsCount(markets, allMarkets);
	JSONArray jsonArray = JSONArray.fromObject(IncidentDAO.getFDFCIncidents(markets, allMarkets, Integer.parseInt(page), Integer.parseInt(rows)));
