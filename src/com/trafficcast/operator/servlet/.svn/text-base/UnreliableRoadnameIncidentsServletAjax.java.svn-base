...
public class UnreliableRoadnameIncidentsServletAjax extends BaseServlet {
    ...
    public void executeServlet(HttpServletRequest request, HttpServletResponse response) throws Exception {	    
	    ...
	    int totalCount = IncidentDAO.getAllUnreliableRoadnameIncidentsCount(searchCriteria);	    
	    JSONArray jsonArray = JSONArray.fromObject(IncidentDAO.getAllUnreliableRoadnameIncidents(searchCriteria));
