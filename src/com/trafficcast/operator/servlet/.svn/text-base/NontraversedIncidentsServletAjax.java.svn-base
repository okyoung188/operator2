...
public class NontraversedIncidentsServletAjax extends BaseServlet {
    ...
    public void executeServlet(HttpServletRequest request, HttpServletResponse response) throws Exception {
	    ...
	    int totalCount = IncidentDAO.getNontraversedIncidentsCount(searchCriteria);	    
	    JSONArray jsonArray = JSONArray.fromObject(IncidentDAO.getNontraversedIncidents(searchCriteria));
